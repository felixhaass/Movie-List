...
IMDBcat <- c("Title", "Year", "Rated", "Released", "Runtime", "Genre", "Director", 
             "Writer", "Actors", "Plot", "Poster", "imdbRating", "imdbVotes", "imdbID", 
             "Type", "Response", "Action", "Animation", "Comedy", "Drama", "Documentary", 
             "Romance", "Short")
...
while (i <= length(movie_names)){
  ...
  # check whether movie was found in OMDB (a successful query results in 16 columns)
  ...
  #create error entry
    ...
    # include in the error message the name of the movie which movie wasn't found
